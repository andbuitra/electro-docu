			...
			<div class="row">
				...
				<div class="col-lg-6 bg-white">
					<div class="form d-flex align-items-center">
						<div class="content">
							<h1 class="forgot-pass">Tu solicitud sera verificada por un administrador quien te dara acceso a la plataforma. Una vez tu cuenta sea aprobada
								se enviara un link de verificación a tu cuenta para completar el proceso de registro.</h1>
